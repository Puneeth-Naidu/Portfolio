...
function App() {
  ...
  return (
    <div className="min-h-screen digital-bg">
      {/* Progress Bar */}
      <motion.div
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between">
            ...
            >
              ...
              <motion.div variants={staggerTextVariants} initial="hidden" animate="visible">
                <motion.h1 className="text-5xl md:text-7xl font-bold mb-4 text-glow">
      ...
      >
        <div className="container mx-auto px-4">
          <motion.h2 
            className="text-4xl md:text-5xl font-bold font-bold text-center mb-16 text-glow"
            variants={textRevealVariants}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
      ...
      >
        <div className="container mx-auto px-4">
          <motion.h2 
            className="text-4xl md:text-5xl font-bold font-bold text-center mb-16 text-white"
            variants={textRevealVariants}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
            ...
            {[
              ...
              >
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-bold font-semibold text-white">
                    {category.title}
                  </h3>
                </div>
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-2xl font-bold font-semibold mb-6 text-white">Programming Languages</h3>
            <div className="flex flex-wrap justify-center gap-4">
              {["Python", "C", "C++", "Java", "JavaScript", "SQL"].map((lang) => (
                <motion.span
                  key={lang}
                  className="bg-digital-blue-800/50 text-white px-6 py-3 rounded-full text-lg font-mono border border-electric-teal-400/30"
                  whileHover={{ 
                    scale: 1.1, 
            ...
            {[
              ...
              >
                <div className="flex justify-between items-start mb-4">
                  <h3 className="text-xl font-bold font-semibold group-hover:text-primary transition-colors">
                    {project.title}
                  </h3>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                    <h3 className="text-2xl font-bold font-semibold">Data Science Intern</h3>
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            >
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                    <h3 className="text-2xl font-bold font-semibold">B. Tech in Computer Science - AI & ML</h3>
                    <div className="flex items-center text-muted-foreground">
                      <Calendar className="w-4 h-4 mr-2" />
            ...
            >
              <h3 className="text-xl font-bold font-semibold mb-6">Certifications</h3>
